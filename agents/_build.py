...
TEAMS = [
    ...
    },
    {
        ...
        "efficio_price": "Built-to-order · from $1,500/mo",
    ...
    },
    {
        ...
        "hero_icon": "layers",
        "pill": "Built for you in 7 days",
        "tagline": "Absorbs the recurring admin — scheduling, inbox triage, review requests, win-back nudges, and the weekly recap — so it runs in the background.",
        "human_role": "office manager", "human_salary": "$45–90K/yr",
        "efficio_price": "Built-to-order · from $1,500/mo",
        "leak_big": None, "leak_label": "The admin that eats your day — scheduling, the inbox, reviews, quiet customers, the weekly report — handled in the background. The Back Office Team is assembled from the modules you already trust, tuned to your recurring tasks.",
        "leak_source": None,
        "what": "The Back Office Team is an assembly of productized modules plus light glue tuned to your specific recurring tasks. It runs scheduling and reminders (Front Office parts), triages your admin inbox and drafts replies, drafts a review request the moment a job closes and tracks your rating, drafts a friendly nudge for quotes gone quiet and past customers who've drifted, automates your highest-value recurring task as draft-safe glue, and compiles a plain-English weekly recap alongside your daily owner brief. One back-office view; the busywork runs while you do the work that matters.",
        "workflow": [
            ("calendar", "Scheduling + reminders", "Booking and reminder automations run (Front Office parts)."),
            ("filter", "Admin inbox triaged", "Sorted by intent and replies drafted."),
            ("star", "Reviews + win-backs", "A review request drafted after every job, a friendly nudge for quiet leads and past customers."),
            ("refresh", "Recurring task automated", "Your highest-value repeating task, built as draft-safe glue."),
            ("chart", "Daily brief + weekly recap", "A daily owner brief and a plain-English weekly recap compile what got handled."),
            ("check", "You see it all", "One back-office view; the busywork runs in the background."),
        ],
        "build": [("D1", "Map the top recurring time-sinks"), ("D2", "Scheduling + reminders"), ("D3", "Inbox / admin triage"), ("D4", "Reviews + win-back nudges"), ("D5", "Highest-value task glue"), ("D6", "Back-office dashboard + recap"), ("D7", "Handoff")],
        "handles": ["Scheduling + reschedules", "Reminders", "Admin inbox triage", "Drafted replies", "Review requests", "Win-back / reactivation nudges", "One recurring task automated", "Daily brief + weekly recap", "Owner overview"],
        "before": ["Reschedules, reminders, and filing eat hours every week.", "The admin inbox is a second full-time job nobody has.", "Happy customers never get asked for a review, and quiet ones never get a nudge back.", "No one ever has time to write up what actually got done."],
        "after": ["Scheduling and reminders run themselves.", "The admin inbox triaged and drafted before you look.", "A review request goes out the moment a job closes, and quiet customers get a friendly nudge back.", "A daily brief and a weekly recap that write themselves — you just read them."],
        "tools": ["Gmail / Outlook (admin inbox)", "Your scheduling system", "Your CRM", "Your Google Business + Facebook review links", "The tools behind your top recurring task (scoped per client)", "Slack / Teams"],
        "dash_kpis": [("Bookings handled · wk", "19"), ("Inbox triaged", "142"), ("Reviews + win-backs sent", "11"), ("Owner brief", "✓")],
        "dash_bars": [12, 18, 15, 21, 19, 24, 22],
        "dash_agents": [("Scheduler", "Runs booking, reschedules, and reminders"), ("Inbox triage", "Sorts the admin inbox and drafts replies"), ("Reviews + win-back", "Drafts a review request after every job and a nudge for quiet leads"), ("Reporter", "Compiles the daily brief and the weekly recap of what got handled")],
    },
]
