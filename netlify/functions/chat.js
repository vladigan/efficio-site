...
- If they ask "is this a fit" → 1–2 quick clarifying questions, then point to the on-site quiz (efficio.tech/find-your-tier.html) or a 15-min call (https://api.leadconnectorhq.com/widget/booking/HS90f7YhCSn6J6nB6j9T).
- If they ask to talk to a human → "Brady answers personally — book 15 min: https://api.leadconnectorhq.com/widget/booking/HS90f7YhCSn6J6nB6j9T, or email brady@efficio.tech."
...
exports.handler = async (event) => {
  ...
  if (!apiKey) {
    return {
      ...
      body: JSON.stringify({
        reply: "I'm not fully wired yet — quickest path is to email brady@efficio.tech or book 15 min at https://api.leadconnectorhq.com/widget/booking/HS90f7YhCSn6J6nB6j9T. He'll answer anything I can't."
      })
    };
  }
  ...
  try {
    ...
    if (!res.ok) {
      ...
      return {
        ...
        headers: { ...corsHeaders(), 'content-type': 'application/json' },
        body: JSON.stringify({
          reply: "I hit a snag reaching my brain. Email brady@efficio.tech or book at https://api.leadconnectorhq.com/widget/booking/HS90f7YhCSn6J6nB6j9T — he answers personally."
        })
      };
    }
    ...
    return {
      ...
      headers: { ...corsHeaders(), 'content-type': 'application/json' },
      body: JSON.stringify({
        reply: "Something broke on my end. Quickest path: email brady@efficio.tech or book at https://api.leadconnectorhq.com/widget/booking/HS90f7YhCSn6J6nB6j9T."
      })
    };
  }
};
